...
function Controller() {
    ...
    __alloyId1.push($.__views.tab1);
    $.__views.seasonWin = __ui.createWindow({
        id: "seasonWin",
        title: "Seasons' List"
    });
    ...
    __alloyId1.push($.__views.tab2);
    $.__views.castWin = __ui.createWindow({
        id: "castWin",
        title: "Cast"
    });
    ...
    __alloyId1.push($.__views.tab2);
    $.__views.tab = __ui.createTabGroup({
        tabs: __alloyId1,
        id: "tab"
    });
