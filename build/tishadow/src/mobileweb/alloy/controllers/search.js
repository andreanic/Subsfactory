...
function Controller() {
    ...
    var $ = this;
    var exports = {};
    $.__views.searchWin = __ui.createWindow({
    ...
    $.__views.mainContainer.add($.__views.__alloyId2);
    ...
    $.__views.__alloyId2.add($.__views.lbl);
    ...
    $.__views.__alloyId3.add($.__views.searchBar);
    ...
    $.__views.__alloyId3.add($.__views.searchButton);
